...
default['cc-webapp']['request_body_max_bytes'] = 10485760
default['cc-webapp']['request_body_no_files_max_bytes'] = 10485760
...
default['cc-webapp']['database']['mysql_package_version'] = '5.7.31-0ubuntu0.16.04.1'
default['cc-webapp']['database']['encoding'] = 'utf8'
default['cc-webapp']['database']['data_dir'] = '/var/lib/mysql-webapp'
default['cc-webapp']['logging']['template'] = 'log4j.properties.erb'
default['cc-webapp']['tomcat']['version'] = '9.0.13'
